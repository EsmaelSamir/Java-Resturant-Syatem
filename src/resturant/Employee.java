...
public class Employee extends JFrame{
    ...
    public Employee() {
        ...
        b[40] = new JButton("Show Report");b[33] = new JButton("Save Report");b[34] = new JButton("Updaten Report");
        b[80] = new JButton("Add Promo");
        ...
        b[33].addActionListener(c);b[34].addActionListener(c);b[40].addActionListener(c);b[80].addActionListener(c);
    ...
    public void Orders(){
          ...
          L[80].setBounds(780,860,150,40);L[80].setFont( new Font("",Font.BOLD,20));first.add(L[80]);
          t[80].setBounds(930,860,150,40);t[80].setFont( new Font("",Font.BOLD,20));first.add(t[80]);
          ...
          b[80].setBounds(900,920, 150, 40);first.add(b[80]);b[80].setFont(  new Font("",NORMAL,20));b[80].setBackground(Color.BLUE);
          b[80].setForeground(Color.YELLOW);
    ...
    private class actionCustomer implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
           ...
           if ( e.getSource() == b[34] ){
                ...
                if (Validation.checkId(t[20].getText())){
                    String [] su = {t[20].getText(),air.getText()};
            ...
            if ( e.getSource() == b[80] ){
                ...
                if (tot.length() < 3 ){
                    ...
                    ArrayList<String> str = of.Search(t[80].getText());
                    if ( str.size() == 0)
                        JOptionPane.showMessageDialog(first, "Promo code not found");
                    else{
